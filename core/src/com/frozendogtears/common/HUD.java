package com.frozendogtears.common;
...
import com.frozendogtears.cavegame.Player;
import com.frozendogtears.cavegenerator.CaveMap;
import com.frozendogtears.cavegenerator.Cell.CellType;
import com.frozendogtears.cavegenerator.MapManager;
import com.frozendogtears.multiplayer.NetworkData;
...
public class HUD {
	...
	public HUD(int w, int h) {
		...
		stage = new Stage();
		hudBatch = (SpriteBatch) stage.getBatch();
